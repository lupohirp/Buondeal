...
export class AppService {
    ...
    public getBrands() {
        return [
            { name: 'aloha', image: 'assets/images/brands/aloha.webp' },
            { name: 'dream', image: 'assets/images/brands/dream.webp' },
            { name: 'congrats', image: 'assets/images/brands/congrats.webp' },
            { name: 'best', image: 'assets/images/brands/best.webp' },
            { name: 'original', image: 'assets/images/brands/original.webp' },
            { name: 'retro', image: 'assets/images/brands/retro.webp' },
            { name: 'king', image: 'assets/images/brands/king.webp' },
            { name: 'love', image: 'assets/images/brands/love.webp' },
            { name: 'the', image: 'assets/images/brands/the.webp' },
            { name: 'easter', image: 'assets/images/brands/easter.webp' },
            { name: 'with', image: 'assets/images/brands/with.webp' },
            { name: 'special', image: 'assets/images/brands/special.webp' },
            { name: 'bravo', image: 'assets/images/brands/bravo.webp' }
        ];
    }
