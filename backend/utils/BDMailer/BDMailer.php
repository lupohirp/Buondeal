...
class BDMailer
{
    ...
    public function __construct($withDebug)
    {
        $this->bdmailer = new PHPMailer(true);
        $this->bdmailer->SMTPDebug  = $withDebug;
    }

    public function sendConfirmationEmail($keyhash, $email)
    {
        require_once($_SERVER['DOCUMENT_ROOT'] . '/../BDEAL_SMTP.php');
        require_once('../../../utils/Logs/LoggerFactory.php');

        bd_log("Invio Mail In corso.... ", "i", basename(__FILE__));
        bd_log("Smtp : " . $smtp_host, "i", basename(__FILE__));
        bd_log("Smtp Port : " . $smtp_port, "i", basename(__FILE__));

        $this->bdmailer->IsSMTP(); // telling the class to use SMTP
        $this->bdmailer->SMTPAuth   = true;                  // enable SMTP authentication
        $this->bdmailer->SMTPSecure = "ssl";
        $this->bdmailer->Host       = $smtp_host;//"smtp.gmail.com";      // SMTP server
        $this->bdmailer->Port       = $smtp_port;                   // SMTP port
        $this->bdmailer->Username   = $smtp_username;  // username
        $this->bdmailer->Password   = $smtp_password;            // password
        $this->bdmailer->setFrom($smtp_username, 'Buondeal');
        $this->bdmailer->Sender = 'info@buondeal.com';

        $this->bdmailer->Subject    = "Registrazione BuonDeal";

        $this->bdmailer->MsgHTML('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
     ...
     <tr style="border-collapse:collapse;">
      <td valign="top" style="padding:0;Margin:0;">
       ...
       <table class="es-header" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#FFA73B;background-repeat:repeat;background-position:center top;">
         <tr style="border-collapse:collapse;">
          <td align="center" bgcolor="#121212" style="padding:0;Margin:0;background-color:#121212;">
                 ...
                 <tr style="border-collapse:collapse;">
                  <td width="580" valign="top" align="center" style="padding:0;Margin:0;">
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-position:left top;">
                     <tr style="border-collapse:collapse;">
                      <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:25px;padding-bottom:25px;"> <img src="https://buondeal.com/backend/utils/BDMailer/images/81661553763309081.png" alt="" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;" width="560" height="180"></td>
                     </tr>
                   </table> </td>
                 </tr>
               </table> </td>
       ...
       <table class="es-content" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;">
         <tr style="border-collapse:collapse;">
          <td style="padding:0;Margin:0;background-color:#121212;" bgcolor="#121212" align="center">
                 ...
                 <tr style="border-collapse:collapse;">
                  <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#FFFFFF;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                     <tr style="border-collapse:collapse;">
                      <td class="es-m-txt-l" bgcolor="#ffffff" align="left" style="Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px;"> <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, helvetica neue, helvetica, arial, sans-serif;line-height:27px;color:#666666;">Benvenuto su Buondeal! Per poter operare,&egrave; necessario confermare il tuo account premendo il seguente pulsante</p> </td>
                     </tr>
                     <tr style="border-collapse:collapse;">
                      <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:35px;padding-bottom:35px;"> <span class="es-button-border" style="border-style:solid;border-color:#FFA73B;background:#121212;border-width:1px;display:inline-block;border-radius:2px;width:auto;"> <a href="https://www,buondeal.com/confirm?key='.$keyhash.'" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, helvetica neue, arial, verdana, sans-serif;font-size:20px;color:#FFFFFF;border-style:solid;border-color:#121212;border-width:15px 30px;display:inline-block;background:#121212;border-radius:2px;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;">Conferma Account</a> </span> </td>
                     </tr>
                     <tr style="border-collapse:collapse;">
                      <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;"> <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, helvetica neue, helvetica, arial, sans-serif;line-height:27px;color:#666666;">Se non dovesse funzionare, copia e incolla il seguente link nel browser</p> </td>
                     </tr>
                     <tr style="border-collapse:collapse;">
                      <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;"> <a target="_blank" href="https://buondeal.com/confirm?key='.$keyhash.'" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, helvetica neue, helvetica, arial, sans-serif;font-size:18px;text-decoration:underline;color:#121212;">https://www.buondeal.com/confirm?key='.$keyhash.'</a></td>
                     </tr>
                     <tr style="border-collapse:collapse;">
                      <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;"> <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, helvetica neue, helvetica, arial, sans-serif;line-height:27px;color:#666666;">Per qualsiasi dubbio e/o domanda siamo sempre a disposizione!</p> </td>
                     </tr>
                     <tr style="border-collapse:collapse;">
                      <td class="es-m-txt-l" align="left" style="Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;padding-bottom:40px;"> <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, helvetica neue, helvetica, arial, sans-serif;line-height:27px;color:#666666;">Saluti,</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, helvetica neue, helvetica, arial, sans-serif;line-height:27px;color:#666666;">Il team Buondeal</p> </td>
                     </tr>
                   </table> </td>
                 </tr>
               </table> </td>
       ...
       <table class="es-content" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;">
        ...
        $this->bdmailer->AddAddress($email);


        if (!$this->bdmailer->Send()) {
            bd_log("Errore durante l'invio della mail : " . $this->bdmailer->ErrorInfo, "e", basename(__FILE__));
        }
    }
}
