...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2020 at 07:15 PM
...
CREATE TABLE `products` (
  ...
  `redirectUrl` varchar(10000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `products` (`id`, `userid`, `categories_id`, `subcategories_id`, `description`, `is_draft`, `title`, `is_free_shipment`, `start_sold_date`, `redirectUrl`) VALUES
(1, 3, 1, 1, '<p>kasdkdsakjdsak</p>', 0, 'ALLLLAAALLALA', 1, '2020-01-13', 'https://www.google.it/');
