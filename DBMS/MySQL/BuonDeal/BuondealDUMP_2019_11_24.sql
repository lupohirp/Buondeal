...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2019 at 10:01 AM
...
(93, 3, 1, 1, '<p>asa</p>\n', 0, 'AAA', 1, '2019-10-26'),
(94, 3, 1, 1, '<p>asa</p>\n', 0, 'AAA', 1, '2019-10-26'),
(107, 3, 1, 1, '<p>AAAAAAAA</p>', 0, 'TEST VENDITA NUOVO', 0, '2019-11-24'),
(108, 3, 1, 1, '<p>CIAOOOOOOO e BAFFANCULO!</p>', 0, 'TEST NUOVO INSERMINTO', 0, '2019-11-24');
...
--
ALTER TABLE `products_images_variants_details`
  ADD CONSTRAINT `products_images_variants_details_ibfk_1` FOREIGN KEY (`variant_id`) REFERENCES `products_variants` (`variant_id`),
  ADD CONSTRAINT `products_images_variants_details_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
