...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2020 at 04:10 PM
...
(5, 3, 1, 1, '<p>fkkfdklsfdslk</p>', 0, 'jfhdjhfdsj', 1, '2020-01-16');
...
(2, 5, 2, 'images/5/2/0.jpg', 'images/5/2/0_big.jpg');
...
(2, 5, 'kfjdskfjdskfjs', 'fkdfkdsjfksjfskjfkdsj');
...
CREATE TABLE `products_variants` (
  ...
  `redirectUrl` varchar(5000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
